...
# vectorizer_file = r"db\lotte__lifestyle__dev__forum\vectorizer.joblib"
# vectorizer = joblib.load(open(vectorizer_file, 'rb'))
# print(f"Loaded TF-IDF vectorizer")

# tfidf_matrix_file = r"db\lotte__lifestyle__dev__forum\tfidf_matrix.joblib"
...
#     reduced_query = svd_model.transform(Y)  # استخدم TruncatedSVD بدل umap
...
# # هنا استخدمنا TruncatedSVD بدل UMAP
...
# query = ["cat and dog"]
# prediction = predict_cluster(vectorizer, model, svd, query)
